...
label partnerMinigame:
    ...
    label NominalDef:
        ...
        menu:
            "Definition of Nominal":
                LI "An easy way to remember is nominal kind of sounds like name."
            "Definition Of Ratio":
                "Wait, this doesn't sound quite right."
                jump NominalDef
            "Definition of Interval":
                LI "This sounds more like interval to me."
                jump NominalDef
            "Definition of Binary":
                "This doesn't seem quite right."
                jump NominalDef
            "Definition of Ordinal":
                Friend "If there's one thing I know, it's that this is the definition of Ordinal."
    ...
    label IntervalDef:
        ...
        Friend "What I really have trouble with is Ratio and Interval. Aren't they like the same thing. Like, they both got numbers right?"
    ...
    label IntervalExample:
        ...
        menu:
            "The time on a broken clock":
                player "The time on a clock could be considered a interval"
                player "You can subtract two different times from each other. But unlike a ratio it doesn't make sense to perform division.
            ...
            "Measuring Cups":
                ...
                LI "So 1/4 cup would not be part of an interval. Since there is a 0 cup and you can form ratios. Like 1/4 cup is exactly half of a half cup"
                jump IntervalExample
    ...
    label ratioExample:
        ...
        menu:
            ...
            "The color of the chair":
                ...
                jump ratioExample
            "The weight of this bottle cap":
                player "Weight is an example of ratio data. There's an absolute 0 and we can multiply, divide and form ratios from weight."
    ...
    player "To demonstrate I'll ask [L.I] a question"
    ...
    LI "Really?"
    Friend "Here's a binary answer they(p) means yes"
